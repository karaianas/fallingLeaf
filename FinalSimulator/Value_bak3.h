...
public:
	...
	Value(double _g = 9.807f, double _t = 0.01f, double _k_ver = 1.0f, double _k_hor = 0.01f, double _len = 1.0f, double _den = 0.1f, \
		double _x_0 = 0.0f, double _y_0 = 100.0f, double _u_0 = 0.00001f, double _v_0 = 0.00001f, double _theta_0 = -60, double _w_0 = 0.0f)//10.1f)//double _theta_0 = -0.1f, double _w_0 = -0.01f)
	{
		g = _g;// gravity
		t = _t;// physical time
	...
	void update()
	{
		...
		// TEST01
		double test = len / 10.0f;

		// acceleration
		udot = -(k_ver * pow(sin(pi / 180.0 * theta_0), 2) + k_hor * pow(len, 3) * pow(cos(pi / 180.0 * theta_0), 2)) * u_0\
			+ (k_ver - k_hor * pow(len, 3)) * sin(pi / 180.0 * theta_0) * cos(pi / 180.0 * theta_0) * v_0\
		...
		//			+ s * test * pow(V, 2) * cos(pi / 180.0 * a + pi / 180.0 * theta_0) * cos(pi / 180.0 * a);

		//vdot = -(k_ver * pow(cos(pi / 180.0 * theta_0), 2) + k_hor * pow(sin(pi / 180.0 * theta_0), 2)) * v_0\
		//			+ (k_ver - k_hor) * sin(pi / 180.0 * theta_0) * cos(pi / 180.0 * theta_0) * u_0\
		//			- s * test * pow(V, 2) * cos(pi / 180.0 * a + pi / 180.0 * theta_0) * sin(pi / 180.0 * a) - g;
		...
		//wdot = -k_ver * w_0 - (3 * pi * 0.1f * pow(V, 2)) * cos(pi / 180.0 * a + pi / 180.0 * theta_0) * sin(pi / 180.0 * a + pi / 180.0 * theta_0);
